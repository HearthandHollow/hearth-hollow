      ...
      <div className="max-w-md bg-white rounded-lg shadow-lg p-8 text-center">
        {isApproved ? (
          <>
            ...
            <h1 className="text-3xl font-bold mb-2 text-gray-900">Quote Approved!</h1>
          ...
          <>
            <div className="text-6xl mb-4">😢</div>
            <h1 className="text-3xl font-bold mb-2 text-gray-900">Quote Declined</h1>
            <p className="text-gray-600 mb-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-gray-600">Reference Number:</p>
              <p className="text-lg font-mono font-bold text-gray-600 break-all">{params.id}</p>
            </div>
          </>
        )}
